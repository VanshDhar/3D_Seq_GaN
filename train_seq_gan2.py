...
class Pix2Pix():
    ...
    def build_generator1(self):
        ...
        b1 = Conv3D(32, (3, 3, 3), strides = 1, padding = 'same')(input_1)
        b1 = LeakyReLU(alpha = 0.2)(b1)
        #b1 = BatchNormalization(momentum = 0.8)(b1)

        b2 = Conv3D(32, (3, 3, 3), strides = (5, 1, 1), padding = 'same')(b1)
        b2 = LeakyReLU(alpha = 0.2)(b2)
        b2 = BatchNormalization(momentum = 0.8)(b2)

        b3 = Conv3D(16, (3, 3, 3), strides = (5, 1, 1), padding = 'same')(b2)
        b3 = LeakyReLU(alpha = 0.2)(b3)
        b3 = BatchNormalization(momentum = 0.8)(b3)

        b4 = Conv3D(8, (1, 3, 3), strides = (2, 1, 1), padding = 'same')(b3)
        b4 = LeakyReLU(alpha = 0.2)(b4)
        b4 = BatchNormalization(momentum = 0.8)(b4)

        b5 = Conv3D(1, (1, 3, 3), strides = 1, padding = 'same')(b4)
        b5 = LeakyReLU(alpha = 0.2)(b5)
        b5 = BatchNormalization(momentum = 0.8)(b5)
    ...
    def train(self, e, epochs, batch_size=1):
        ...
        for epoch in range(e, epochs+1):
            ...
            path1='/home/users/student21/projectMNIT/data/seq_gan2/g_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path1):
                os.makedirs(path1)
            path2='/home/users/student21/projectMNIT/data/seq_gan2/g_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path2):
                os.makedirs(path2)
            path3='/home/users/student21/projectMNIT/data/seq_gan2/d_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path3):
                os.makedirs(path3)
            path4='/home/users/student21/projectMNIT/data/seq_gan2/d_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path4):
                os.makedirs(path4)
                
            self.save_model(self.g_1, path='/home/users/student21/projectMNIT/data/seq_gan2/g_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.g_2, path='/home/users/student21/projectMNIT/data/seq_gan2/g_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_1, path='/home/users/student21/projectMNIT/data/seq_gan2/d_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_2, path='/home/users/student21/projectMNIT/data/seq_gan2/d_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
...
if __name__ == '__main__':
    gan = Pix2Pix()
    gan.train(e=1, epochs=100, batch_size=1)
