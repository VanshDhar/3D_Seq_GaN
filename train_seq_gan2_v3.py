# -*- coding: utf-8 -*-
"""
Created on Mon Feb  3 17:29:16 2020
...
class Pix2Pix():
    def __init__(self):
        ...
        self.epochs = 100
        self.batch_size = 1
        self.training_samples = 5753  #88831, 4217, 1182 , 951 , 1451 , 302 , 433, 266, 4252 , 1951 , 48285 , 5953, 5753
        self.epoch_resume = 1
    ...
    def build_generator1(self):
        ...
        model = Conv3D(128, (3, 3, 3), strides = (1, 1, 1), padding = 'same', data_format = 'channels_last')(input_1)
        model = ap3d(pool_size=(5, 3, 3), strides = (5, 1, 1), padding = 'same', data_format = 'channels_last')(model)
        model = Activation('relu')(model)
                
        model = Conv3D(64, (3, 3, 3), strides = 1, padding = 'same', data_format = 'channels_last')(model)
        model = ap3d(pool_size = (2, 3, 3), strides = (2, 1, 1), padding = 'same', data_format = 'channels_last')(model)        
        model = Activation('relu')(model)

        model = Conv3D(32, (3, 3, 3), strides = 1, padding = 'same', data_format = 'channels_last')(model)
        model = ap3d(pool_size = (5, 3, 3), strides = (5, 1, 1), padding = 'same', data_format = 'channels_last')(model)
        model = Activation('relu')(model)

        model = Conv3D(16, (1, 3, 3), strides = 1, padding = 'same', data_format = 'channels_last')(model)
        model = ap3d(pool_size = (1, 3, 3), strides = (1, 1, 1), padding = 'same', data_format = 'channels_last')(model)
        model = Activation('relu')(model)
        ...
        d4 = deconv3d(d3, e0, self.df) # 128 X 128 X 32
    ...
    def build_generator2(self):
        ...
        """
        a2 = Conv3D(16, (1, 3, 3), strides = 1, padding = 'same')(a1)
        a2 = LeakyReLU(alpha = 0.2)(a2)
        a2 = BatchNormalization(momentum = 0.8)(a2)
        """
    ...
    def build_discriminator1(self):
        ...
        def d_layer(layer_input, filters, f_size=(1,3,3), bn=True):
            """Discriminator layer"""
            d = Conv3D(filters, kernel_size=f_size, strides=(1, 2, 2), padding='same')(layer_input)
            d = LeakyReLU(alpha=0.2)(d)
            if bn:
    ...
    def build_discriminator2(self):
        ...
        img_B = Input(shape=self.img_shape2) 
    ...
    def train(self, epochs, batch_size=1):
        ...
        for epoch in range(self.epoch_resume, epochs+1):
            ...
            path1='/home/users/student21/projectMNIT/data/seq_gan2_v3/g_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path1):
                os.makedirs(path1)
            path2='/home/users/student21/projectMNIT/data/seq_gan2_v3/g_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path2):
                os.makedirs(path2)
            path3='/home/users/student21/projectMNIT/data/seq_gan2_v3/d_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path3):
                os.makedirs(path3)
            path4='/home/users/student21/projectMNIT/data/seq_gan2_v3/d_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path4):
                os.makedirs(path4)
                
            self.save_model(self.g_1, path='/home/users/student21/projectMNIT/data/seq_gan2_v3/g_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.g_2, path='/home/users/student21/projectMNIT/data/seq_gan2_v3/g_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_1, path='/home/users/student21/projectMNIT/data/seq_gan2_v3/d_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_2, path='/home/users/student21/projectMNIT/data/seq_gan2_v3/d_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
...
if __name__ == '__main__':
    path1 = '/home/users/student21/projectMNIT/data/seq_gan2_v3/g_1/*'
    path2 = '/home/users/student21/projectMNIT/data/seq_gan2_v3/g_2/*'
    path3 = '/home/users/student21/projectMNIT/data/seq_gan2_v3/d_1/*'
    path4 = '/home/users/student21/projectMNIT/data/seq_gan2_v3/d_2/*'
