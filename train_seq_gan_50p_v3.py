...
class Pix2Pix():
    def __init__(self):
        ...
        self.epochs = 50
        self.batch_size = 1
        self.training_samples = 1172  #88831, 4217, 1182 , 951 , 1451 , 302 , 433, 266, 4252 , 1951 , 48285 , 5953, 5753
        self.epoch_resume = 1
    ...
    def train(self, epochs, batch_size=1):
        ...
        for epoch in range(self.epoch_resume, epochs+1):
            ...
            path1='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/g_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path1):
                os.makedirs(path1)
            path2='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/g_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path2):
                os.makedirs(path2)
            path3='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/d_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path3):
                os.makedirs(path3)
            path4='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/d_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path4):
                os.makedirs(path4)
                
            self.save_model(self.g_1, path='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/g_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.g_2, path='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/g_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_1, path='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/d_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_2, path='/home/users/student21/projectMNIT/data/seq_gan_50p_v3/d_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
...
if __name__ == '__main__':
    path1 = '/home/users/student21/projectMNIT/data/seq_gan_50p_v3/g_1/*'
    path2 = '/home/users/student21/projectMNIT/data/seq_gan_50p_v3/g_2/*'
    path3 = '/home/users/student21/projectMNIT/data/seq_gan_50p_v3/d_1/*'
    path4 = '/home/users/student21/projectMNIT/data/seq_gan_50p_v3/d_2/*'
