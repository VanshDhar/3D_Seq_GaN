...
class Pix2Pix():
    ...
    def build_generator1(self):
        ...
        b1 = Conv3D(32, (5, 3, 3), strides = (5, 1, 1), padding = 'same')(input_1)
        b1 = LeakyReLU(alpha = 0.2)(b1)
        #b1 = BatchNormalization(momentum = 0.8)(b1)

        b2 = Conv3D(16, (5, 3, 3), strides = (5, 1, 1), padding = 'same')(b1)
        b2 = LeakyReLU(alpha = 0.2)(b2)
        b2 = BatchNormalization(momentum = 0.8)(b2)

        b3 = Conv3D(8, (2, 3, 3), strides = (2, 1, 1), padding = 'same')(b2)
        b3 = LeakyReLU(alpha = 0.2)(b3)
        b3 = BatchNormalization(momentum = 0.8)(b3)

        b4 = Conv3D(1, (1, 3, 3), strides = 1, padding = 'same')(b3)
        b4 = LeakyReLU(alpha = 0.2)(b4)
        b4 = BatchNormalization(momentum = 0.8)(b4)

        #U-Net

        #Encoder

        e0 = conv3d(b4, self.gf)
        ...
        return Model(input_1, output_img)
    ...
    def build_discriminator1(self):
        ...
        validity = Conv3D(1, kernel_size=(1, 3, 3), strides=1, padding='same')(d4)
    ...
    def train(self, epochs, batch_size=1):
        ...
        for epoch in range(self.epoch_resume, epochs+1):
            ...
            path1='/home/users/student21/projectMNIT/data/seq_gan1/g_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path1):
                os.makedirs(path1)
            path2='/home/users/student21/projectMNIT/data/seq_gan1/g_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path2):
                os.makedirs(path2)
            path3='/home/users/student21/projectMNIT/data/seq_gan1/d_1/e'+str(epoch).zfill(3)
            if not os.path.exists(path3):
                os.makedirs(path3)
            path4='/home/users/student21/projectMNIT/data/seq_gan1/d_2/e'+str(epoch).zfill(3)
            if not os.path.exists(path4):
                os.makedirs(path4)
                
            self.save_model(self.g_1, path='/home/users/student21/projectMNIT/data/seq_gan1/g_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.g_2, path='/home/users/student21/projectMNIT/data/seq_gan1/g_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_1, path='/home/users/student21/projectMNIT/data/seq_gan1/d_1/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
            self.save_model(self.d_2, path='/home/users/student21/projectMNIT/data/seq_gan1/d_2/e'+str(epoch).zfill(3)+'/', model_name = 'model', weights_name = 'weights')
...
if __name__ == '__main__':
    path1 = '/home/users/student21/projectMNIT/data/seq_gan1/g_1/*'
    path2 = '/home/users/student21/projectMNIT/data/seq_gan1/g_2/*'
    path3 = '/home/users/student21/projectMNIT/data/seq_gan1/d_1/*'
    path4 = '/home/users/student21/projectMNIT/data/seq_gan1/d_2/*'
