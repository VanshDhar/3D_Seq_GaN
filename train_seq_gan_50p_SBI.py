...
my_epoch = 100
my_batch_size = 1
training_samples =  2188 #2586 #1451 # 88831, 4217, 1182 , 951 , 1451 , 302 , 433, 266, 4252 , 1951 , 48285 , 5953, 5753 change
epoch_resume = 0
...
def OurGenerator(batch_size = 1, depth = 50, size_shape = (256, 256)): # , resize_shape, crop_shape, horizontal_flip, vertical_flip , brightness, rotation, zoom , resize_shape = ( 256, 256)
    ...
    void_label = 0
    #full_label = 1
    folder=r'C:\Users\santo\OneDrive\Desktop\soumendu_work\dataset2014'#change
