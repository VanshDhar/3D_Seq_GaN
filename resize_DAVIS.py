...
dataset2= {'480p': ['bear', 'blackswan', 'bmx-bumps', 'bmx-trees', 'boat', 'breakdance', 'breakdance-flare', 'bus',
                    'camel', 'car-roundabout', 'car-shadow', 'car-turn', 'cows', 'dance-jump', 'dance-twirl', 'dog', 
                    'dog-agility', 'drift-chicane', 'drift-straight', 'drift-turn', 'elephant', 'flamingo', 'goat', 
                    'hike', 'hockey', 'horsejump-high', 'horsejump-low', 'kite-surf', 'kite-walk', 'libby', 'lucia', 
                    'mallard-fly', 'mallard-water', 'motocross-bumps', 'motocross-jump', 'motorbike', 'paragliding', 
            ...
            '1080p': ['bear', 'blackswan', 'bmx-bumps', 'bmx-trees', 'boat', 'breakdance', 'breakdance-flare', 'bus',
                      'camel', 'car-roundabout', 'car-shadow', 'car-turn', 'cows', 'dance-jump', 'dance-twirl', 'dog', 
                      'dog-agility', 'drift-chicane', 'drift-straight', 'drift-turn', 'elephant', 'flamingo', 'goat', 
                      'hike', 'hockey', 'horsejump-high', 'horsejump-low', 'kite-surf', 'kite-walk', 'libby', 'lucia', 
                      'mallard-fly', 'mallard-water', 'motocross-bumps', 'motocross-jump', 'motorbike', 'paragliding', 
...
for category in dataset1:   
        ...
        for scene in scene_list:
            ...
            print('RESIZING -->> '+category+' / '+scene)
            part2Name = folder + '\\' + str(category) + '_in_256\\' + scene                                                                                      

            if not os.path.exists(part2Name):
                os.makedirs(part2Name)
        
            image_path_list = glob.glob(os.path.join(folder+'\\'+category+'\\'+scene+ '\\'+'*g'))
            ...
            for image_path in image_path_list:
                ...
                image.save(folder + '\\' + str(category) + '_in_256\\' + scene +'\\'+((os.path.basename(image_path)).split('.')[-2])+'.jpg')
